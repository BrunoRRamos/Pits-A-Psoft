...
public class SaborControllerTests {
  ...
  class SaborVerificacaoFluxosBasicosApiRest {
    ...
    void quandoBuscamosPorUmSaborSalvo() throws Exception {
      ...
      SaborResponseDTO resultado = objectMapper
          .readValue(responseJsonString,
              SaborResponseDTO.SaborResponseDTOBuilder.class)
          .build();
    ...
    void quandoCriarSaborValido() throws Exception {
      ...
      SaborResponseDTO resultado = objectMapper
          .readValue(responseJsonString, SaborResponseDTO.SaborResponseDTOBuilder.class)
          .build();
      ...
      assertAll(
          ...
          () -> assertEquals(saborPostPutRequestDTO.getPrecoM(),
              resultado.getPrecoM()),
          () -> assertEquals(saborPostPutRequestDTO.getPrecoG(),
              resultado.getPrecoG()),
          () -> assertEquals(saborPostPutRequestDTO.getDisponivel(),
              resultado.getDisponivel()));
    }
    ...
    void quandoAlteramosSaborValido() throws Exception {
      ...
      saborPostPutRequestDTO.setNome("Pepperoni");
  ...
  class SaborVerificacaoDisponibilidade {
    ...
    void quandoAlteramosSaborDisponibilidadeValida() throws Exception {
      ...
      String responseJsonString = driver.perform(patch(URI_SABORES + "/disponibilidade")
          ...
          .param("estabelecimentoId", estabelecimento.getId().toString())
          .param("estabelecimentoCodigoAcesso", estabelecimento.getCodigoAcesso())
          .content(objectMapper.writeValueAsString(SaborDisponibilidadePatchDTO.builder()
    ...
    void quandoAlteramosSaborDisponibilidadeNula() throws Exception {
      ...
      String responseJsonString = driver.perform(patch(URI_SABORES + "/disponibilidade")
          ...
          .content(objectMapper.writeValueAsString(
              SaborDisponibilidadePatchDTO.builder().build())))
          .andExpect(status().isBadRequest()) // Codigo 200
          .andDo(print())
          .andReturn().getResponse().getContentAsString();
